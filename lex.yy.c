...
step 1) "gcc lex.yy.c y.tab.c -w"  run this in terminal
step 2) ./a.exe or ./a.out
step 3) "(2+2)-2*5/4%5"   run this or any other expression
 * 
 *              Aim:Study and Implementation of LEX YACC
 */
#line 3 "lex.yy.c"
